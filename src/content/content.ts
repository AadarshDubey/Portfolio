...
export const siteConfig: SiteConfig = {
    ...
    resumeUrl: "/AadarshDubey.pdf",
    resumeDriveUrl: "https://drive.google.com/file/d/1p3_-trN1jDjl1elDL7ExHbt9cgmdpNm9/view?usp=sharing",
    social: {
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        description:
            "Built an AI-powered multi-agent audit tool using Streamlit, Google Gemini API, and the Google Agent Development Kit (ADK) that autonomously analyzes SoW documents, flags risks, detects quality issues, and generates comprehensive audit reports with actionable redline suggestions.",
        problem:
        ...
        solution:
            "Developed a specialized multi-agent architecture using the Google Agent Development Kit (ADK) to automate SoW document ingestion, perform smart parsing, and execute inter-agent feedback loops for highly accurate context analysis and risk flagging.",
        features: [
            "Specialized multi-agent architecture (Parser, Risk, Quality agents)",
            "Inter-agent feedback loops for highly accurate context analysis",
            "Automated SoW document ingestion and smart parsing",
            "Vague language & scope creep risk identification",
            "Missing section & structural quality issue detection",
            "Detailed audit report generation with context-aware redline suggestions",
        ],
        tags: ["GenAI", "Agents", "Enterprise"],
        stack: [
            "Python",
            "Streamlit",
            "Google Gemini API",
